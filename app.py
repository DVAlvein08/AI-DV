...
user_input["Benzylpenicillin"] = st.radio("Benzylpenicillin", ["Không", "Có"], horizontal=True, key="input_23") == "Có"
user_input["Ceftriaxone"] = st.radio("Ceftriaxone", ["Không", "Có"], horizontal=True, key="input_24") == "Có"
user_input["Levofloxacin"] = st.radio("Levofloxacin", ["Không", "Có"], horizontal=True, key="input_25") == "Có"
user_input["Moxifloxacin"] = st.radio("Moxifloxacin", ["Không", "Có"], horizontal=True, key="input_26") == "Có"
user_input["Clindamycin"] = st.radio("Clindamycin", ["Không", "Có"], horizontal=True, key="input_27") == "Có"
user_input["Linezolid"] = st.radio("Linezolid", ["Không", "Có"], horizontal=True, key="input_28") == "Có"
user_input["Cefotaxime"] = st.radio("Cefotaxime", ["Không", "Có"], horizontal=True, key="input_29") == "Có"
user_input["Vancomycin"] = st.radio("Vancomycin", ["Không", "Có"], horizontal=True, key="input_30") == "Có"
user_input["Tigecycline"] = st.radio("Tigecycline", ["Không", "Có"], horizontal=True, key="input_31") == "Có"
user_input["Rifampicin"] = st.radio("Rifampicin", ["Không", "Có"], horizontal=True, key="input_32") == "Có"
user_input["Trimethoprim"] = st.radio("Trimethoprim", ["Không", "Có"], horizontal=True, key="input_33") == "Có"
user_input["Fusidic acid"] = st.radio("Fusidic acid", ["Không", "Có"], horizontal=True, key="input_34") == "Có"
user_input["Oxacillin"] = st.radio("Oxacillin", ["Không", "Có"], horizontal=True, key="input_35") == "Có"
user_input["Gentamicin"] = st.radio("Gentamicin", ["Không", "Có"], horizontal=True, key="input_36") == "Có"
user_input["Ciprofloxacin"] = st.radio("Ciprofloxacin", ["Không", "Có"], horizontal=True, key="input_37") == "Có"
user_input["Teicoplanin"] = st.radio("Teicoplanin", ["Không", "Có"], horizontal=True, key="input_38") == "Có"
user_input["Meropenem"] = st.radio("Meropenem", ["Không", "Có"], horizontal=True, key="input_39") == "Có"
user_input["Piperacillin"] = st.radio("Piperacillin", ["Không", "Có"], horizontal=True, key="input_40") == "Có"
user_input["Piperacillin/ Tazobactam"] = st.radio("Piperacillin/ Tazobactam", ["Không", "Có"], horizontal=True, key="input_41") == "Có"
user_input["Ertapenem"] = st.radio("Ertapenem", ["Không", "Có"], horizontal=True, key="input_42") == "Có"
user_input["Imipenem"] = st.radio("Imipenem", ["Không", "Có"], horizontal=True, key="input_43") == "Có"
user_input["Amoxicilin clavulanic"] = st.radio("Amoxicilin clavulanic", ["Không", "Có"], horizontal=True, key="input_44") == "Có"
...
if st.button("🔍 Dự đoán"):
    ...
    # Ép đúng thứ tự cột đầu vào như model
